...
import com.richway.layers.BaiduTiledMapServiceLayer;
import com.richway.layers.GoogleMapLayer;
...
public class LayerCreator
{
    ...
    private static function createLayer(layerCreationProperties:LayerCreationProperties):Layer
    {
		...
		{
			return createGoogleMapLayer(layerCreationProperties);
		}
		else if (layerType == "googlemapimage")
		{
			return createGoogleMapImageLayer(layerCreationProperties);
		}
		else if (layerType == "googlemappoi")
		{
			return createGoogleMapPoiLayer(layerCreationProperties);
		}
		else if (layerType == "baidumap")
		{
			return createBaiduMapLayer(layerCreationProperties);
		}
		else if (layerType == "baidumappoi")
		{
			return createBaiduMapPoiLayer(layerCreationProperties);
		}
		else if (layerType == "baidumapimage")
		{
			return createBaiduMapImageLayer(layerCreationProperties);
		}
        else
        {
	...
	private static function createBaiduMapImageLayer(layerCreationProperties:LayerCreationProperties):Layer
	{
		// TODO Auto Generated method stub
		var baiduMapLayer:BaiduTiledMapServiceLayer=new BaiduTiledMapServiceLayer();                         
		baiduMapLayer.name=layerCreationProperties.label;                         
		baiduMapLayer.id=layerCreationProperties.label;                         
		baiduMapLayer.alpha=layerCreationProperties.alpha;                         
		baiduMapLayer.visible=layerCreationProperties.visible; 
		baiduMapLayer.mapType="image";
		if (layerCreationProperties.copyright != null)
		{
			baiduMapLayer.copyright = layerCreationProperties.copyright;
		}
		if (layerCreationProperties.displayLevels)
		{
			baiduMapLayer.displayLevels = toNumericArray(layerCreationProperties.displayLevels.split(","));
		}
		if (!isNaN(layerCreationProperties.minScale))
		{
			baiduMapLayer.minScale = layerCreationProperties.minScale;
		}
		if (!isNaN(layerCreationProperties.maxScale))
		{
			baiduMapLayer.maxScale = layerCreationProperties.maxScale;
		}                        
		return baiduMapLayer;
	}
	
	private static function createBaiduMapPoiLayer(layerCreationProperties:LayerCreationProperties):Layer
	{
		// TODO Auto Generated method stub
		var baiduMapLayer:BaiduTiledMapServiceLayer=new BaiduTiledMapServiceLayer();                         
		baiduMapLayer.name=layerCreationProperties.label;                         
	...
	private static function createBaiduMapLayer(layerCreationProperties:LayerCreationProperties):Layer
	{
		// TODO Auto Generated method stub
		var baiduMapLayer:BaiduTiledMapServiceLayer=new BaiduTiledMapServiceLayer();                         
		baiduMapLayer.name=layerCreationProperties.label;                         
	...
	private static function createGoogleMapImageLayer(layerCreationProperties:LayerCreationProperties):Layer
	{
		// TODO Auto Generated method stub
		
		var googleMapLayer:GoogleMapLayer=new GoogleMapLayer();                         
		googleMapLayer.name=layerCreationProperties.label;                         
		googleMapLayer.id=layerCreationProperties.label;                         
		googleMapLayer.alpha=layerCreationProperties.alpha;                         
		googleMapLayer.visible=layerCreationProperties.visible; 
		googleMapLayer.mapType="image";
		if (layerCreationProperties.copyright != null)
		{
			googleMapLayer.copyright = layerCreationProperties.copyright;
		}
		if (layerCreationProperties.displayLevels)
		{
		...
		if (!isNaN(layerCreationProperties.minScale))
		{
			googleMapLayer.minScale = layerCreationProperties.minScale;
		}
		if (!isNaN(layerCreationProperties.maxScale))
		{
			googleMapLayer.maxScale = layerCreationProperties.maxScale;
		}                        
		return googleMapLayer;
	}
	
	private static function createGoogleMapPoiLayer(layerCreationProperties:LayerCreationProperties):Layer
	{
		// TODO Auto Generated method stub
		var googleMapLayer:GoogleMapLayer=new GoogleMapLayer();     
		                 
